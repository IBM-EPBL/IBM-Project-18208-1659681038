...
def sendmail(TEXT,email):
    ...
    s = smtplib.SMTP('smtp.gmail.com', 587)
    s.starttls()
    s.login("srinivas051201@gmail.com", "oms@1Ram")
    message  = 'Subject: {}\n\n{}'.format(SUBJECT, TEXT)
    s.sendmail("srinivas051201@gmail.com", email, message)
    s.quit()
def sendgridmail(user,TEXT):
    sg = sendgrid.SendGridAPIClient('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')
    from_email = Email("srinivas051201@gmail.com")  # Change to your verified sender
